...
public class SinLeerFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < cursor_check.getCount(); i++) {
            ...
            String CHECK_QUERY = "SELECT autor FROM '" + check_tabla + "' WHERE leido = 0";
        ...
        if(checker.size()>0) {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                String RAW_QUERY_2 = "SELECT id,autor,fecha,titulo,mensaje,leido FROM '" + nombre_tabla + "' WHERE leido = 0";
                ...
                for (int j = 0; j < cursor2.getCount(); j++) {
                    ...
                    boton.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View v) {
                            ...
                            datos.putString("desde","sin_leer");
            ...
            no_mensajes.setText("No hay mensajes sin leer.");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_sin_leer_fragment,null);
    }
    ...
    public void borraMensaje(String nombre_tabla,int id){
        ...
        Log.d("desde","hola estamo en fragment sin leer");
        FragmentManager fragmentManager = getFragmentManager();
        //fragmentManager.popBackStack("root_fragment", FragmentManager.POP_BACK_STACK_INCLUSIVE);
        FragmentTransaction ft = fragmentManager.beginTransaction();
        ft.replace(R.id.screen_area,fragment)/*.addToBackStack("root_fragment")*/;
